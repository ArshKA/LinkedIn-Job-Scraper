...
while True:
    ...
    print('TOTAL RESULTS:', len(all_results), '|TOTAL UN-SPONSORED:', total_non_sponsored, '|TOTAL NEW RESULTS:', len(new_results), '|TOTAL NEW UN-SPONSORED:', total_new_non_sponsored)
    if not first:
